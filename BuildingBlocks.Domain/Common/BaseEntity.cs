...
public abstract class BaseEntity
{
    ...
    [NotMapped] public IProducerConsumerCollection<DomainEvent> DomainEvents => _domainEvents;
    [NotMapped] public IProducerConsumerCollection<IntegrationEvent> IntegrationEvents => _integrationEvents;
